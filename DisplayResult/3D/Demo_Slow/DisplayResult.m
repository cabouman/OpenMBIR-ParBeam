...
% Arguments 
ImageBaseName='afrl'; 
ImageDirName= '../../../Data/3D/Demo_Slow/Reconstruction/Image/'; % Directory in which image files for each slice are located
ImageParamsFname = '../../../Data/3D/Demo_Slow/Parameters/afrl.imgparams'; % Image Parameters File Name
